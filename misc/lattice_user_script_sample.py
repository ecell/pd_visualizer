...
def output_frames_fluori2d_sample():
    ...
    lset=LatticeSettings()
    lset.set_camera(zoom=1.0,base_position=(-2.0, 0.4292, 0.4292), focal_point=(0, 0.4292, 0.4292))
    lset.set_particle(sphere_resolution=16)
    lset.set_movie(frame_interval=0.033, exposure_time=0.033, frame_end_time=10.0)
