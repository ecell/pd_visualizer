...
from particle_visualizer \
    import ParticleSettings, ParticleVisualizer
from fluori2d_drawer import Fluori2dDrawer


DATA_FILE = './hdf5_particle/dimer.hdf5'
#DATA_FILE = './hdf5_particle/dimer_lack.hdf5'
DATA_FILES = './hdf5_particle/*.hdf5'
...
def output_movie_sample():
    ...
    pset=ParticleSettings()
    pvis=ParticleVisualizer([DATA_FILE],
        image_file_dir = 'my_image', movie_filename='particle.mp4',
        settings=pset)
...
def output_frames_custom_sample():
    ...
    pset=ParticleSettings()
    pset.set_image(file_name_format = 'case2_%04d.png')
...
def output_frames_focused_sample():
    ...
    pset.set_image(file_name_format = 'case_focuse_%04d.png')
...
def output_frame_filtered_sample():
    ...
    pset = ParticleSettings({'camera_view_angle':5})
    pset.set_image(file_name_format = 'case_filter_%04d.png')
