...
import render_lattice_settings
import lattice_converter
...
from render_fluori2d_drawer import Fluori2dDrawer, gauss_func
...
class LatticeSettings(RenderSettings):
    ...
    def __init__(self, user_settings_dict = None):
        ...
        settings_dict_lattice = render_lattice_settings.__dict__.copy()
...
class LatticeVisualizer(RenderVisualizer):
        ...
        for hdf5_file_path in hdf5_file_path_list:
            try:
                ...
                for lattice_dset_name in header_group:
                    ...
                    lattice_list=lattice_converter.lattice_factory(lattice_dset_name,schema_list)
