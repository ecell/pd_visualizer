...
vs = visualizer.Visualizer([DATA_FILE], 
    image_file_dir = './images', movie_filename='case2.mp4',
    settings=settings)
vs.output_snapshots()
vs.make_movie()
...
vs = visualizer.Visualizer([DATA_FILE],
    movie_filename='case3.mp4', settings=settings)
vs.output_movie()
...
vs = visualizer.Visualizer(glob.glob(DATA_FILES),
    movie_filename='case4.mp4', settings=settings)
vs.output_movie()
...
vs = visualizer.Visualizer([DATA_FILE], 
    image_file_dir = './images', movie_filename='case5.mp4',
    settings=settings)
vs.output_snapshots()
vs.make_movie()
